...
- [GoPay](https://github.com/go-pay/gopay) - 支付 SDK。
- [PhotoPrism](https://github.com/photoprism/photoprism) - AI 驱动的照片应用程序。
- [Go Ethereum](https://github.com/ethereum/go-ethereum) - 以太坊协议的官方实现。
- [CloudQuery](https://github.com/cloudquery/cloudquery) - 高性能数据集成平台。
...
- [JustAuth](https://github.com/justauth/JustAuth) - 第三方登录组件。
...
- [The Algorithms](https://github.com/TheAlgorithms) - 最大的开源算法库。
...
- [LeetCode](https://github.com/azl397985856/leetcode) - 算法通关之路。
- [LeetCode Master](https://github.com/youngyangyang04/leetcode-master) - 代码随想录。
- [LeetCode Go](https://github.com/halfrost/LeetCode-Go) - Go 算法。
...
- [Docker](https://github.com/docker) - Docker 容器。
...
- [KubeSphere](https://github.com/kubesphere/kubesphere) - 面向云原生应用的容器混合云。
- [Rainbond](https://github.com/goodrain/rainbond) - 云原生多云应用管理平台。
- [Kuboard](https://github.com/eip-work/kuboard-press) - 微服务管理界面。
...
- [Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) - 黑客集合。
...
- [Nodejs](https://github.com/sindresorhus/awesome-nodejs) - Node.js 资源。
- [Flutter](https://github.com/Solido/awesome-flutter) - Flutter 资源。
- [CPP](https://github.com/fffaraz/awesome-cpp) - C/C++ 资源。
- [Scalability](https://github.com/binhnguyennus/awesome-scalability) - 大型系统架构。
- [Java](https://github.com/akullpp/awesome-java) - Java 资源。
...
- [Docker Compose](https://github.com/docker/awesome-compose) - Docker Compose 示例。
- [Electron](https://github.com/sindresorhus/awesome-electron) - Electron 资源。
- [Falsehood](https://github.com/kdeldycke/awesome-falsehood) - 谎言。
...
- [Resume for Chinese](https://github.com/dyweb/awesome-resume-for-chinese) - 中文简历模板。
- [Pentest](https://github.com/enaqx/awesome-pentest) - 渗透测试。
- [Sysadmin](https://github.com/awesome-foss/awesome-sysadmin) - 系统管理员。
- [Design Systems](https://github.com/alexpate/awesome-design-systems) - UI 设计。
- [NLP](https://github.com/keon/awesome-nlp) - 自然语言处理。
- [Readme](https://github.com/matiassingers/awesome-readme) - 自述文件。
- [GraphQL](https://github.com/chentsulin/awesome-graphql) - GraphQL 资源。
- [ZSH Plugins](https://github.com/unixorn/awesome-zsh-plugins) - ZSH 插件。
- [Microservices](https://github.com/mfornos/awesome-microservices) - 微服务架构。
- [Quant](https://github.com/wilsonfreitas/awesome-quant) - 量化交易。
- [LowCode](https://github.com/taowen/awesome-lowcode) - 国内低代码平台。
- [Cli Apps](https://github.com/agarrharr/awesome-cli-apps) - 命令行应用。
- [Creative Coding](https://github.com/terkelg/awesome-creative-coding) - 创意编码。
- [Tailwind CSS](https://github.com/aniftyco/awesome-tailwindcss) - Tailwind CSS 资源。
- [Cheatsheets](https://github.com/skywind3000/awesome-cheatsheets) - 速查表。
...
- [Guidelines](https://github.com/Kristories/awesome-guidelines) - 高质量编码风格指南。
- [Privacy](https://github.com/pluja/awesome-privacy) - 隐私。
- [Leading and Managing](https://github.com/LappleApple/awesome-leading-and-managing) - 领导力和管理。
- [Bash](https://github.com/awesome-lists/awesome-bash) - Bash 资源。
...
- [Hugo](https://github.com/theNewDynamic/awesome-hugo) - Hugo 相关。
- [ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) - ChatGPT 提示。
...
- [Public Datasets](https://github.com/awesomedata/awesome-public-datasets) - 公共数据集。
- [Wechat Weapp](https://github.com/justjavac/awesome-wechat-weapp) - 微信小程序开发资源。
- [GitHub](https://github.com/AntBranch/awesome-github) - GitHub 资源。
- [Architect](https://github.com/xingshaocheng/architect-awesome) - 后端架构师技术图谱。
...
- [Computer Science](https://github.com/ossu/computer-science) - 通往计算机科学之路。
- [CS-Books](https://github.com/forthespada/CS-Books) - 超过 1000 本的计算机经典书籍。
- [CS-Notes](https://github.com/CyC2018/CS-Notes) - 技术面试必备基础知识。
- [awesome-cs-books](https://github.com/imarvinle/awesome-cs-books) - 经典编程书籍大全。
- [System Design Primer](https://github.com/donnemartin/system-design-primer) - 系统设计入门。
- [system_architect](https://github.com/xxlllq/system_architect) - 系统架构设计师复习资料。
- [Build your own X](https://github.com/codecrafters-io/build-your-own-x) - 构建您喜欢的技术。
- [You Dont Know JS](https://github.com/getify/You-Dont-Know-JS) - 关于 JavaScript 的丛书。
...
- [Advanced Go Programming](https://github.com/chai2010/advanced-go-programming-book) - Go 高级编程。
- [gopl-zh](https://github.com/golang-china/gopl-zh) - Go 圣经。
- [go-perfbook](https://github.com/dgryski/go-perfbook) - Go 性能优化。
...
- [hacker-laws](https://github.com/dwmkerr/hacker-laws) - 黑客法。
- [Security 101 for SaaS startups](https://github.com/forter/security-101-for-saas-startups) - SaaS 型初创企业安全。
...
- [kubernetes-handbook](https://github.com/rootsongjc/kubernetes-handbook) - Kubernetes 中文指南。
- [learning_tools](https://github.com/hwholiday/learning_tools) - Go 项目实践。
- [project-layout](https://github.com/golang-standards/project-layout) - Go 项目布局。
- [go-backend-clean-architecture](https://github.com/amitshekhariitbhu/go-backend-clean-architecture) - Go 整洁架构。
- [go-clean-template](https://github.com/evrone/go-clean-template) - Go 整洁模板。
- [architecture-of-internet-product](https://github.com/davideuler/architecture.of.internet-product) - 互联网公司技术架构。
- [System Design Course](https://github.com/karanpratapsingh/system-design) - 系统设计课程。
- [design-patterns-for-humans](https://github.com/kamranahmedse/design-patterns-for-humans) - 设计模式大白话。
- [Web-Notes](https://github.com/wx-chevalier/Web-Notes) - 现代 Web 开发基础与工程实践。
- [Developer-Zero-To-Mastery](https://github.com/wx-chevalier/Developer-Zero-To-Mastery) - 程序员的技术视野、知识管理与职业规划。
...
- [Nodejs Best Practices](https://github.com/goldbergyoni/nodebestpractices) - Node.js 最佳实践。
- [clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript) - JavaScript 的干净代码。
- [CSS Protips](https://github.com/AllThingsSmitty/css-protips) - CSS 编程技巧。
- [chinese-copywriting-guidelines](https://github.com/sparanoid/chinese-copywriting-guidelines) - 中文文案排版指北。
- [Uber Go Guide](https://github.com/uber-go/guide) - Uber Go 风格指南。
- [Python Guide](https://github.com/realpython/python-guide) - Python 最佳实践指南。
- [Zh Google Style Guide](https://github.com/zh-google-styleguide/zh-google-styleguide) - Google 开源项目风格指南 (中文版)。
- [Project Guidelines](https://github.com/elsewhencode/project-guidelines) - 项目开发指南。
- [go-best-practice](https://github.com/llitfkitfk/go-best-practice) - Go 最佳实践。
...
- [php-the-right-way](https://github.com/codeguy/php-the-right-way) - PHP 最佳实践。
- [clean-code-php](https://github.com/piotrplenik/clean-code-php) - PHP 的干净代码。
- [clean-go-article](https://github.com/Pungyeon/clean-go-article) - Go 的干净代码。
...
- [Compose Specification](https://github.com/compose-spec/compose-spec) - Docker Compose 撰写规范。
...
- [Back-End Developer Interview Questions](https://github.com/arialdomartini/Back-End-Developer-Interview-Questions) - 后端开发人员面试问题。
- [Front-end Interview Handbook](https://github.com/yangshun/front-end-interview-handbook) - 前端面试手册。
- [PHPerInterviewGuide](https://github.com/todayqq/PHPerInterviewGuide) - PHP 面试指南。
- [PHP-Interview-QA](https://github.com/colinlet/PHP-Interview-QA) - PHP 面试问答。
- [PHP-Interview](https://github.com/xianyunyh/PHP-Interview) - PHP 面试。
- [interview_internal_reference](https://github.com/0voice/interview_internal_reference) - 总结阿里、腾讯、百度、美团、头条等技术面试题目。
- [Reverse interview](https://github.com/viraptor/reverse-interview) - 反向面试。
...
- [GitHub-Chinese-Top-Charts](https://github.com/GrowingGit/GitHub-Chinese-Top-Charts) - GitHub 中文排行榜。
- [GitHub-rank](https://github.com/jaywcjlove/github-rank) - Github 中国用户排名。
- [GitHub Readme Stats](https://github.com/anuraghazra/github-readme-stats) - GitHub 统计信息。
- [creative-profile-readme](https://github.com/coderjojo/creative-profile-readme) - 开发人员自述文件。
- [beautify-github-profile](https://github.com/rzashakeri/beautify-github-profile) - 漂亮的自述文件。
- [github-profile-readme-generator](https://github.com/rahuldkjain/github-profile-readme-generator) - GitHub 自述文件生成器。
